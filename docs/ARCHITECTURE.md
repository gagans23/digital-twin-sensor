...
| 4 | Semantic summaries/OCR gate | Implemented for macOS Apple Vision helper with Tesseract CLI fallback | Store local redacted summary only, discard temporary images |
